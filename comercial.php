                ...
                <div class="row modal-main">
		           ...
		           <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp delay-03s" style="visibility: visible; animation-name: fadeInUp;">
                        <div class="property-box">
                            ...
                            <div class="detail">
                                <h1 class="title">
                                    <a href="http://thavasu.com/demo/property-listing/listing/013v1332/1-bhk-house-for-rent">1 BHK House for rent</a>
                                </h1>
                                <div class="location">
                                ...
                                <ul class="facilities-list clearfix">
                                    <li>
                                        <i class="flaticon-bed"></i> 7                                    </li>
                                    <li>
                                        <i class="flaticon-bathtub"></i> 7 
                                    </li>
                                    <li>
                                        <i class="flaticon-square"></i> 234                                    </li>
                                </ul>
                            </div>
			        ...
			        <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp delay-03s" style="visibility: visible; animation-name: fadeInUp;">
                        <div class="property-box">
                            ...
                            <div class="detail">
                                <h1 class="title">
                                    <a href="http://thavasu.com/demo/property-listing/listing/RAFK9025/home-alone">Home alone</a>
                                </h1>
                                <div class="location">
                                    <a href="http://thavasu.com/demo/property-listing/listing/RAFK9025/home-alone">
                                        <i class="fa fa-map-marker"></i>,
                                    </a>
                                </div>
                                <ul class="facilities-list clearfix">
                                    <li>
                                        <i class="flaticon-furniture"></i> 6                                    </li>
                                    <li>
                                        <i class="flaticon-holidays"></i> 4 
                                    </li>
                                    <li>
                                        <i class="flaticon-square"></i> 1023                                    </li>
                                </ul>
                            </div>
                            <div class="footer clearfix">
                        ...
                        <div class="property-box">
                            <div class="property-thumbnail">
                                <a href="properties-details.php" class="property-img">
                                    ...
                                    <img class="d-block w-100" src="image/img_section/sec4.jpg" alt="properties">
                                </a>
                            </div>
                            <div class="detail">
                                <h1 class="title">
                        ...
                        <div class="property-box">
                            <div class="property-thumbnail">
                                <a href="properties-details.php" class="property-img">
                                    ...
                                    <img class="d-block w-100" src="image/img_section/sec5.jpg" alt="properties">
                                </a>
                            </div>
                            <div class="detail">
                                <h1 class="title">
                        ...
                        <div class="property-box">
                            <div class="property-thumbnail">
                                <a href="properties-details.php" class="property-img">
                                    ...
                                    <img class="d-block w-100" src="image/img_section/sec7.jpg" alt="properties">
                                </a>
                            </div>
                            <div class="detail">
                                <h1 class="title">
